...
public class StudyGroup implements Serializable {
    private long id = 1;
    private String name;
    private data.Coordinates coordinates;
    ...
    public StudyGroup(long id, String name, data.Coordinates coordinates, Integer studentsCount,
                      FormOfEducation formOfEducation, data.Semester semesterEnum, Person groupAdmin) {
        if (id <= 0)
    ...
    public data.Coordinates getCoordinates() {
        return coordinates;
    }
    ...
    public data.Semester getSemester() {
        return semesterEnum;
    }
